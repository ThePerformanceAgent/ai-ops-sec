...
export async function GET({ site }: APIContext) {
	...
	const body = [
		...
		`> ${SITE.en.description}`,
		'',
		`Author: ${AUTHOR.name} (${AUTHOR.github}). Text licensed CC BY 4.0; code MIT. Every article lists its sources, what was verified by hand and a change history. Please cite the article URL and date.`,
		'',
